...
% 自定义颜色
\definecolor{primary_color}{RGB}{152,25,76}    % 松针绿
...
% 学院
\newcommand{\school}{计算机与软件学院 | College of Computer Science and Software Engineering} 
...
\newcommand{\contact}{
    ...
    \textcolor{white}{
        % 邮箱
        \faEnvelope \quad \href{mailto:youremail@email.szu.edu.cn}{youremail@email.szu.edu.com}
        \hspace{4em}
        % 手机号
...
\begin{document}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=north, inner sep=0pt](header) at (current page.north){
            \includegraphics[width=\paperwidth]{images/header.jpg}
        };
        \node[anchor=west](school_logo) at (header.west){
            \hspace{0.5cm}
            \includegraphics[width=0.2\textwidth]{images/SZU-logo.png}
        };
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south, inner sep=0pt](footer) at (current page.south){
            \includegraphics[width=\paperwidth]{images/footer.jpg}
        };
        % 联系方式
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[opacity=0.05] at(current page.center){
            \includegraphics[width=0.7\paperwidth, keepaspectratio]{images/SZU-logo-dark.jpg}
        };
    \end{tikzpicture}
